...
import { lighten, toHex } from "../../../classes/render-util";
import { waitAnimationFrames } from "../../../classes/misc-util";
/**
 * @internal
 */
export class DsScrollContainer {
  constructor() {
  ...
  init(container) {
    ...
    waitAnimationFrames(10).then(this.updateHandler);
  }
  ...
  handleVerticalScrollBarMouseDown(e) {
    ...
    const mouseOverScrollBar = clamp(localMouseY, scrollBarBeginY, scrollBarEndY) == localMouseY;
  ...
  handleHorizontalScrollBarMouseDown(e) {
    ...
    const mouseOverScrollBar = clamp(localMouseX, scrollBarBeginX, scrollBarEndX) == localMouseX;
    if (!mouseOverScrollBar) {
  ...
  getScrollPositionY(mouseY) {
    ...
    const yWithinTarget = clamp(mouseOnTop, 0, this.verticalScrollContainerHeight);
  ...
  getScrollPositionX(mouseX) {
    ...
    const xWithinTarget = clamp(mouseOnLeft, 0, this.horizontalScrollContainerWidth);
    const result = (xWithinTarget / max) *
      (this.scrollContainer.scrollWidth - this.scrollContainer.offsetWidth);
    return result;
  }
  render() {
    return (h(Host, null, h("slot", null), this.renderScrollBars()));
  }
  ...
  createVerticalScrollBar(middle, offset, color, borderRadius) {
    if (this.visibleVertical) {
      ...
      return (h("div", { class: {
        ...
        }, onMouseDown: (e) => this.handleVerticalScrollBarMouseDown(e), style: Object.assign(Object.assign({}, verticalScrollBarPosition), { top: this.verticalScrollContainerY + "px", height: this.verticalScrollContainerHeight + "px", width: this.scrollBarWidth + "px", "background-color": color, "border-radius": borderRadius }) }, h("div", { style: {
  ...
  createHorizontalScrollBar(middle, color, borderRadius) {
    if (this.visibleHorizontal) {
      ...
      return (h("div", { class: {
        ...
        }, onMouseDown: (e) => this.handleHorizontalScrollBarMouseDown(e), style: Object.assign(Object.assign({}, horizontalScrollBarPosition), { left: this.horizontalScrollContainerX + "px", width: this.horizontalScrollContainerWidth + "px", height: this.scrollBarWidth + "px", "background-color": color, "border-radius": borderRadius }) }, h("div", { style: {
  ...
  renderScrollBars() {
    if (!(this.visibleVertical || this.visibleHorizontal))
      return null;
    const scrollBarContainerColor = lighten(this.thumbcolor, this.scrollbarcolorfactor) +
      toHex(this.scrollbaropacity * 255);
  ...
  static get is() { return "ds-scroll-container"; }
  static get encapsulation() { return "shadow"; }
  static get originalStyleUrls() {
    return {
      "$": ["ds-scroll-container.scss"]
    };
  }
  static get styleUrls() {
    return {
      "$": ["ds-scroll-container.css"]
    };
  }
  static get properties() {
    return {
      ...
      "verticalscrollbarposition": {
        ...
        "attribute": "verticalscrollbarposition",
        "reflect": false,
        "defaultValue": "\"right\""
      },
      "horizontalscrollbarposition": {
        ...
        "attribute": "horizontalscrollbarposition",
        "reflect": false,
        "defaultValue": "\"bottom\""
      },
      "scrollbarcolorfactor": {
        "type": "number",
        "mutable": false,
        "complexType": {
          "original": "number",
        ...
        "attribute": "scrollbarcolorfactor",
        "reflect": false,
        "defaultValue": "0.5"
      },
      "scrollbarborderradius": {
        ...
        "attribute": "scrollbarborderradius",
        "reflect": false,
        "defaultValue": "7"
      },
      "scrollbaropacity": {
  ...
  static get events() {
    return [{
        "method": "scrollVerticalActive",
        "name": "scrollVerticalActive",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
        ...
        "method": "scrollHorizontalActive",
        "name": "scrollHorizontalActive",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
  ...
  static get watchers() {
    return [{
        "propName": "currentDraggingBar",
        "methodName": "onDraggingBarChanged"
      }];
  }
}

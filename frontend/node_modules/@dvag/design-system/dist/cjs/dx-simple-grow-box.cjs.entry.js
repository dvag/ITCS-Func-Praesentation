...
const DxSimpleGrowBox = class {
  constructor(hostRef) {
    ...
    this.growBoxStateChange = index.createEvent(this, "growBoxStateChange", 7);
  ...
  componentWillUpdate() {
    ...
    return new Promise((resolve) => {
      renderUtil.onNextFrame(resolve);
    });
  }
  render() {
    ...
    return (index.h(index.Host, { style: {
      ...
      } }, index.h("div", { ref: (ref) => this.resizeObserver.observe(ref) }, index.h("slot", null)))));
  }
...
exports.dx_simple_grow_box = DxSimpleGrowBox;

...
const DxDateInput = class {
  ...
  renderInput() {
    var _a;
    const error$1 = ((_a = this.internalErrorMessage) === null || _a === void 0 ? void 0 : _a.length) > 0 || error.hasError(this.self);
    return (index.h("label", { id: elementIdHandling.ElementIdGenerator.createId(this.self, "control") }, index.h(inputContainer.LabeledInputContainer, { containerProperties: {
      ...
      } }, index.h("dx-flyout", { open: this.inputFocused, offsety: 4, hideoverlay: !this.calendarenabled }, index.h("div", { class: {
        "inner-container": true,
        "size-s": this.size === "s",
        "size-m": this.size === "m",
        active: this.inputFocused,
        error: error$1,
      } }, index.h("div", { class: "input-container" }, this.renderDayInput(), this.renderMonthInput(), this.renderYearInput()), this.renderIconOrClearButton()), this.renderCalendar()))));
  }
  renderClearButton() {
  ...
  renderIconOrClearButton() {
    ...
    return (index.h("div", { class: "right-side" }, isClearButtonVisible ? (this.renderClearButton()) : (index.h("dx-icon", { icon: "kalender", size: 24 }))));
  }
  renderCalendar() {
    var _a, _b;
    ...
    return (index.h("dx-calendar", { slot: "overlay", id: elementIdHandling.ElementIdGenerator.createId(this.self, "calendar"), ref: (ref) => this.setCalendar(ref), mode: this.mode, tabindex: -1, min: (_a = this.min) !== null && _a !== void 0 ? _a : "", max: (_b = this.max) !== null && _b !== void 0 ? _b : "", errormessage: this.internalErrorMessage, onBlur: () => {
        this.onBlur();
        this.dayInputController.onBlur();
      }, onRangeSelected: (e) => {
  ...
  render() {
    ...
    if (this.readonly) {
      ...
      return (index.h(baseElements.ReadonlyTextElement, { text: ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 ? this.getFormattedDisplayDate(date) : "n.a.", label: this.label }));
    }
...
exports.dx_date_input = DxDateInput;

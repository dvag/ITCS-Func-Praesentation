...
const DsModal = class {
  ...
  render() {
    assert.assertPropertyValue("ds-modal", "size", this.size, [
      "fullscreen",
      "content",
    ]);
    assert.assertPropertyValue("ds-modal", "contentcolor", this.contentcolor, [
      "weiss",
      "grau",
    ]);
    const isRightButtonDefined = renderUtil.isSlotDefined(this.self, RIGHT_BUTTON);
    const isLeftButtonDefined = renderUtil.isSlotDefined(this.self, LEFT_BUTTON);
    ...
    return (index.h(index.Host, { class: {
      ...
      } }, index.h("div", { class: "overlay" }), index.h("div", { class: "modal-layout", onClick: (e) => this.closeModalOnClickOutside(e), onAnimationEnd: () => this.layoutAnimationEnd() }, index.h("div", { ref: (el) => (this.modalDialog = el), class: "modal-element" }, this.renderHeader(), this.renderContent(countOfDefinedSlots), this.renderFooter(countOfDefinedSlots), index.h("div", { class: "header-shadow" }), index.h("div", { class: {
        "footer-shadow": true,
  ...
  renderHeader() {
    ...
    return (index.h("div", { class: "header" }, index.h("div", { class: "header-side" }), index.h("div", { class: "header-label" }, index.h("ds-text", { type: "ftf" }, this.label)), index.h("div", { class: "header-side" }, index.h("ds-function-icon-button", { id: elementIdHandling.ElementIdGenerator.createId(this.self, "close-button"), onClick: () => this.closeModal() }, index.h("ds-icon", { id: elementIdHandling.ElementIdGenerator.createId(this.self, "close-button"), icon: "schliessen-dialog", size: 32 })))));
  }
  renderContent(countOfDefinedSlots) {
    return (index.h("div", { ref: (el) => (this.scrollableElement = el), class: {
        content: true,
  ...
  renderFooter(countOfDefinedSlots) {
    ...
    return (index.h("div", { class: {
        ...
        "one-slot": countOfDefinedSlots === 1,
        "two-slots": countOfDefinedSlots === 2,
      } }, index.h("div", { class: "footer-left-button" }, index.h("slot", { name: "left-button" })), index.h("div", null, index.h("slot", { name: "right-button" }))));
  }

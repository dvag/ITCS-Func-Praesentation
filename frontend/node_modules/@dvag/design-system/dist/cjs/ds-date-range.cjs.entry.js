...
const DsDateRange = class {
  ...
  connectedCallback() {
    this.slotObserver = new slotObserver.SlotObserver(this.self, "ds-date-input", (dateInputs) => {
      assert.assert(dateInputs.length === 2, () => "You have to define exactly two ds-date-inputs within this component");
  ...
  async focusControl() {
    var _a;
    (_a = this.self.querySelector("ds-date-input")) === null || _a === void 0 ? void 0 : _a.focusControl();
  }
  updateCalendarValue() {
  ...
  handleBlur() {
    renderUtil.onNextFrame(() => {
      const loseFocus = document.activeElement !== this.self &&
        !miscUtil.findUpperElementByPredicate(document.activeElement, (elem) => elem === this.self);
      if (loseFocus) {
        this.currentlyFocused = false;
      }
    });
  ...
  getDateInputs() {
    return Array.from(this.self.querySelectorAll("ds-date-input"));
  }
  ...
  renderCalendar() {
    ...
    const dateInputs = this.getDateInputs();
    return (index.h("ds-calendar", { slot: "overlay", id: elementIdHandling.ElementIdGenerator.createId(this.self, "calendar"), ref: (ref) => this.setCalendar(ref), tabindex: -1, errormessage: this.internalErrorMessage ||
        ((_a = dateInputs[0]) === null || _a === void 0 ? void 0 : _a.errormessage) ||
        ((_b = dateInputs[1]) === null || _b === void 0 ? void 0 : _b.errormessage), rangeenabled: true, onBlur: () => {
        this.onBlur();
  ...
  render() {
    return (index.h(index.Host, null, index.h("dx-overlay", { position: "bottom", offsety: 8, disabled: !this.currentlyFocused }, index.h("div", { class: "date-container" }, index.h("div", { class: "date-input-container" }, index.h("slot", { name: "from" })), index.h("div", { class: "date-input-container" }, index.h("slot", { name: "to" }))), this.renderCalendar())));
  }
...
DsDateRange.style = dsDateRangeCss;

exports.ds_date_range = DsDateRange;

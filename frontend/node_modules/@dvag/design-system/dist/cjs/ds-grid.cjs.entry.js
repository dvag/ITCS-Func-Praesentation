...
const DsGrid = class {
  ...
  componentWillLoad() {
    assert.assert((this.s || this.m || this.l || this.xl) != null, () => '<ds-grid> Es muss mindestens eine Größenangabe für die Properties "xl", "l", "m" oder "s" getätigt werden');
  ...
  connectedCallback() {
    this.breakpointAware = new breakpointAware.BreakpointAware(() => this.updateChosenGrid());

...
const DsFormLayout = class {
  ...
  renderSlotDependantOfSize() {
    const namedSlots = [
      index.h("div", { class: "label" }, this.renderLabelSlot()),
      index.h("div", { class: "interaction" }, this.renderInteractionSlot()),
    ];
    if (this.internalSize === "l") {
      return index.h("div", { class: "column" }, namedSlots);
    }
    return namedSlots;
  }
  renderInteractionSlot() {
    ...
    if (!usesDsInfoInsideInteractionSlot && size !== "xl") {
      return (index.h("ds-info", { hidebutton: true }, index.h("slot", { name: "interaction" })));
    }
    else {
      return index.h("slot", { name: "interaction" });
    }
  }
  renderLabelSlot() {
    var _a, _b;
    ...
    if (!usesDsInfoInsideLabelSlot && size === "l") {
      return (index.h("ds-info", { hidebutton: true }, index.h("slot", { name: "label" })));
    }
    else {
      return index.h("slot", { name: "label" });
    }
  }
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "layout", style: Object.assign({}, this.buildCssGridStyle()) }, this.renderSlotDependantOfSize())));
  }
...
exports.ds_form_layout = DsFormLayout;

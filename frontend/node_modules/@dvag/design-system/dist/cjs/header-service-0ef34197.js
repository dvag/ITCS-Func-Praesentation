...
class HeaderService {
  constructor() {
    ...
    this.contentHeightBelowHeaderSubject = new multicastObservable.DsSubject();
...
function subscribeToContentHeightBelowHeader(heightChangeCallback) {
...
exports.subscribeToContentHeightBelowHeader = subscribeToContentHeightBelowHeader;

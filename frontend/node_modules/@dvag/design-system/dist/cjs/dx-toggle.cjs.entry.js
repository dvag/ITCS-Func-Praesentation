...
const DxToggle = class {
  ...
  render() {
    return (index.h(index.Host, { class: { disabled: this.disabled, checked: this.checked } }, index.h("label", { class: "label" }, index.h("input", { disabled: this.disabled, type: "checkbox", checked: this.checked, onChange: (e) => {
        this.checked = e.target.checked;
        this.checkedChange.emit(this.checked);
      } }), index.h("div", { class: "toggle-container" }, index.h("div", { class: "slider" }), index.h("div", { class: "bubble" }, index.h("dx-icon", { icon: this.checked ? "check" : "schliessen", size: 16 }))))));
  }
};
DxToggle.style = dxToggleCss;

exports.dx_toggle = DxToggle;

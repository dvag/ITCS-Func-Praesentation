...
const DxTableCell = class {
  ...
  getInnerElement() {
    ...
    if (currentType === "currency") {
      ...
      return this.renderCellText(`${currencyText} €`);
    }
    if (currentType === "date") {
  ...
  renderCellText(text) {
    return (index.h("div", { class: "overflow-container" }, index.h("dx-text", null, text)));
  }
  handleContextMenu(e) {
    e.preventDefault();
  ...
  getStyle() {
    ...
    if (this.color != null) {
      style["background-color"] = new colorPalette.ColorPalette(true).getColorCode(this.color);
    }
  ...
  renderPopup(alignClass) {
    ...
    return (index.h("div", { class: Object.assign({ "popup-container": true }, alignClass) }, index.h("div", { class: "overlay", onTouchEnd: (e) => {
        e.stopPropagation();
        e.preventDefault();
        this.showTooltip = false;
      } }), index.h("dx-popup", { arrowposition: alignment !== "center" ? alignment !== null && alignment !== void 0 ? alignment : "left" : "left", show: true }, index.h("dx-text", null, this.tooltipText))));
  }
...
exports.dx_table_cell = DxTableCell;

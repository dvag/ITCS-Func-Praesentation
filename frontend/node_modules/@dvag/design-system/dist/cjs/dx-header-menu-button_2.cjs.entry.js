...
const DxHeaderMenuButton = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("button", { id: elementIdHandling.ElementIdGenerator.createId(this.self, "control"), class: {
        button: true,
        active: this.active,
        selected: this.selected,
      }, onClick: () => {
        this.interaction.emit();
      } }, index.h("dx-notification-indicator", { theme: this.notificationstheme, notifications: this.getNotifications() }, index.h("dx-element-swapper", { active: this.active ? "second" : "first" }, index.h("slot", { slot: "first" }), index.h("dx-icon", { slot: "second", icon: "schliessen", color: "headline", size: 24 }))), index.h("div", { class: "line" }))));
  }
...
const DxNotificationIndicator = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("slot", null), index.h("div", { class: {
...
exports.dx_header_menu_button = DxHeaderMenuButton;
exports.dx_notification_indicator = DxNotificationIndicator;

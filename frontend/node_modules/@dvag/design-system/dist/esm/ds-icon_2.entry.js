...
const DsIcon = class {
  ...
  render() {
    ...
    return (h(Host, { style: generateStyleMap$1(size, this.color) }, h("span", null)));
  }
...
export { DsIcon as ds_icon, DsText as ds_text };

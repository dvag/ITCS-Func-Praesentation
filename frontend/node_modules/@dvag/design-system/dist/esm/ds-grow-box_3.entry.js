...
const DsGrowBox = class {
  constructor(hostRef) {
    ...
    this.growboxGrowStart = createEvent(this, "growboxGrowStart", 7);
    this.growStart = createEvent(this, "growStart", 7);
    this.contentVisibilityChange = createEvent(this, "contentVisibilityChange", 7);
...
const DsInputLabel = class {
  ...
  render() {
    var _a;
    return (h(Host, { class: { visible: ((_a = this.label) === null || _a === void 0 ? void 0 : _a.length) > 0 || this.kisynced } }, h("div", { class: { "label-icon-container": true, "ki-synced": this.kisynced, "align-right": this.alignRight } }, h("ds-text", { class: { disabled: this.disabled } }, this.label), h("div", { class: "non-clickable-container", onClick: (e) => {
        e.preventDefault();
      } }), this.renderSyncIcon())));
  }
  renderSyncIcon() {
...
const DsRequiredHint = class {
  ...
  render() {
    ...
    return (h(Host, null, h("ds-grow-box", { open: !this.fulfilled, animateoninit: false, class: "animation-container" }, h("div", { class: {
        "hint-container": true,
        fulfilled: this.fulfilled,
      } }, h("div", { class: "hint" }, h("ds-icon", { icon: "achtung-circle", size: 16, color: "gelb-1" }), h("ds-text", { type: "itk" }, "Pflichtfeld"))))));
  }
};
DsRequiredHint.style = dsRequiredHintCss;

export { DsGrowBox as ds_grow_box, DsInputLabel as ds_input_label, DsRequiredHint as ds_required_hint };

...
import { c as assertPropertyValue, a as assert } from './assert-7fc7463a.js';
...
const DsButton = class {
  ...
  render() {
    assertPropertyValue("ds-button", "type", this.type, [
      "primary",
      "secondary",
    ]);
    assertPropertyValue("ds-button", "size", this.size, ["medium", "small"]);
    return (h(Host, { class: {
...
const DsLogo = class {
  ...
  render() {
    return (h(Host, null, h("span", null)));
  }
  get self() { return getElement(this); }
};
...
const DsUserAvatar = class {
  ...
  render() {
    assert(this.imageurl != null || this.initials != null, () => "<ds-user-avatar> Es wurde weder 'imageurl' noch 'initials' definiert. Eins von beiden muss gesetzt sein.");
    assertPropertyValue("ds-user-avatar", "size", this.size, [
      "header",
      "content-s",
      "content-m",
      "content-l",
  ...
  renderInitials() {
    var _a;
    return (h("div", { class: "initials" }, h("ds-text", null, (_a = this.initials) !== null && _a !== void 0 ? _a : "")));
  }
};
DsUserAvatar.style = dsUserAvatarCss;

export { DsButton as ds_button, DsLogo as ds_logo, DsUserAvatar as ds_user_avatar };

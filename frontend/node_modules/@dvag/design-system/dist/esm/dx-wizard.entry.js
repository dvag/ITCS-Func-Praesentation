...
import { g as getDefinedSlots } from './render-util-1dee6655.js';
import { B as BreakpointAware } from './breakpoint-aware-0017fabb.js';
import { g as generatePageIndexTypes, G as GAP } from './page-index-type-e2dfccdf.js';
...
import { G as GridBreakpoint } from './grid-models-f7973aae.js';
...
const DxWizard = class {
  constructor(hostRef) {
    ...
    this.currentStepChange = createEvent(this, "currentStepChange", 7);

...
import { a as isMenuItem, i as isMenuLink, b as isMenuGroup } from './header-menu.util-16645eb3.js';
...
const DxHeaderMenuBar = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.sidebarOpenChange = createEvent(this, "sidebarOpenChange", 7);
...
const DxLogo = class {
  ...
  render() {
    ...
    return (h(Host, null, h(Logo, null)));
  }
  get self() { return getElement(this); }
};
DxLogo.style = dxLogoCss;

export { DxHeaderApplicationName as dx_header_application_name, DxHeaderMenuBar as dx_header_menu_bar, DxLogo as dx_logo };

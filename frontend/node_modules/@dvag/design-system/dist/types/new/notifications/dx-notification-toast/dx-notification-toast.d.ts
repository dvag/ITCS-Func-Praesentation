 ...
 */
export declare class DxNotificationToast implements ComponentInterface {
  private closeHandle;
  private currentXOffset;
  private breakpointAware;
  private start;
  private restTime;
  private flyout;
  private swipeController;
  self: HTMLDxNotificationToastElement;
  show: boolean;
  animating: boolean;
  closingDirection: "top" | "left" | "right";
  /**
  ...
  closeafter: number;
  /**
   * Specifies the visibility. If the notification closes automatically, by swiping the toast away (mobile only) or by clicking on the close button.
  ...
  private onSwipeUpdate;
  private onSwipeRecognized;
  private resetTimerProperties;
  private startTimer;
  private stopTimer;
  renderTitle(): any;
